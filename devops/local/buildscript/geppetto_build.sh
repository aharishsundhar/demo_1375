...
DESKTOPCODE='../../../application/client/desktop/demo_1375'
DESKTOPIMAGENAME='geppettotest/demo_1375-desktop:1.0'
...
helm install --name demo_1375 ./helm
if [ $? -eq 0 ]; then
